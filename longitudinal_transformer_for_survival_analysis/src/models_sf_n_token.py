...
import sys
import os
sys.path.insert(0, "/home/lin01231/song0760/deformable_detr")
...
def create_model(args):
    if args.use_deformable_spatial and args.use_deformable_temporal:
        encoder = DeformableSpatialEncoder(d_model=768, n_heads=4, n_points=args.n_points_s)
        temporal_encoder = DeformableTemporalEncoder(d_model=768, n_heads=4, max_len=args.max_seq_len, n_points=args.n_points_t)
        ...
        temporal_encoder = nn.Sequential(
            ...
            DeformableTemporalEncoder(d_model=768, n_heads=4, max_len=args.max_seq_len)
        )

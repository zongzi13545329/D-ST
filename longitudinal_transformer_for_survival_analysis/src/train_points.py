...
from models_sf_n_token import create_model as sf_create_model
...
def main(args):
    ...
    MODEL_NAME += f'_nps-{args.n_points_s}'
    MODEL_NAME += f'_npt-{args.n_points_t}'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_deformable_spatial', action='store_true', default=True, help='Use deformable attention in spatial encoder')
    parser.add_argument('--use_deformable_temporal', action='store_true', default=True, help='Use deformable attention for temporal encoder')
    parser.add_argument('--n_points_s', type=int, default=4, help='Number of sampling points for spatial deformable attention')
    parser.add_argument('--n_points_t', type=int, default=4, help='Number of sampling points for temporal deformable attention')
